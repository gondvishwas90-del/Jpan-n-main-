...
import { Headphones, ArrowRight, MessageSquare, ShieldCheck, Mail, BarChart3 } from "lucide-react";
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="animate-in fade-in slide-in-from-left duration-700 delay-200">
              <div className="flex items-center gap-2 mb-6 md:mb-8">
                ...
                <span className="text-gold font-bold uppercase tracking-widest text-xs">Financial Support</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                <button 
                  ...
                  className="px-8 sm:px-12 py-5 sm:py-6 bg-gold text-charcoal font-bold text-[10px] uppercase tracking-[0.3em] rounded-xl transition-all flex items-center justify-center gap-4 shadow-2xl hover:bg-white whitespace-nowrap"
                >
                  Contact IR Desk
                ...
                <div className="flex items-center gap-5 px-6 sm:px-8 py-5 sm:py-6 bg-white/5 border border-white/10 rounded-xl text-white">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-[0.2em]">Fiscal Transparency</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between w-full animate-in fade-in slide-in-from-right duration-700 delay-400">
              ...
              >
                <div className="p-6 sm:p-10 bg-white/5 border border-white/10 rounded-2xl hover:border-gold/50 transition-all group/card w-full min-w-full sm:min-w-0 sm:w-full shrink-0 snap-center shadow-sm">
                  ...
                  <h4 className="text-white font-bold text-xs sm:text-sm uppercase tracking-widest mb-2">Investor Email</h4>
                  <p className="text-silver/60 text-xs font-medium">enquiry@jpantubular.com</p>
                </div>

                <div className="p-6 sm:p-10 bg-white/5 border border-white/10 rounded-2xl hover:border-gold/50 transition-all group/card w-full min-w-full sm:min-w-0 sm:w-full shrink-0 snap-center shadow-sm">
                  <Headphones className="w-8 h-8 sm:w-10 sm:h-10 text-gold mb-6 group-hover/card:scale-110 transition-transform" />
                  <h4 className="text-white font-bold text-xs sm:text-sm uppercase tracking-widest mb-2">Direct Support</h4>
                ...
                <div className="sm:col-span-2 p-6 sm:p-10 bg-white/2 border border-white/5 rounded-2xl flex items-center justify-between w-full min-w-full sm:min-w-0 sm:w-full shrink-0 snap-center shadow-sm">
                  <div className="flex items-center gap-4 sm:gap-6">
                    ...
                    <div>
                      <h4 className="text-white font-bold text-xs uppercase tracking-widest mb-1">Verified Data</h4>
                      <p className="text-silver/60 text-xs leading-relaxed">All credit rating data is independently verified by authorized agencies.</p>
                    </div>
                  </div>
