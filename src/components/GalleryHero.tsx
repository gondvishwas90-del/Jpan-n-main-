...
import { Camera, Aperture, Factory, Sparkles } from "lucide-react";
    ...
    <section className="relative min-h-[460px] md:min-h-[500px] pt-32 pb-20 flex items-center overflow-hidden bg-[#070d14]">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt="J Pan Manufacturing Excellence Gallery"
          fill
          priority
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            >
              ...
              <span className="text-gold font-extrabold">Manufacturing Gallery</span>
            </motion.nav>
            ...
            >
              Explore the scale, precision, and technical sophistication that defines J Pan Tubular Components Limited's world-class manufacturing facilities.
            </motion.p>
          </div>
          ...
          <div className="lg:col-span-4 hidden lg:block">
            ...
            >
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-heading font-bold text-white">High Fidelity Visuals</h3>
                <p className="text-xs text-white/70 leading-relaxed font-normal">
                  High-definition technical photography showcasing CNC rotary benders, robotic brazing cells, and metrology labs.
                </p>
              </div>
