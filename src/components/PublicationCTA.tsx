...
import { Mail, ArrowRight, MessageSquare, Phone, Info, Globe } from "lucide-react";
...
export function PublicationCTA() {
  ...
  return (
    <section className="py-12 md:py-24 bg-white dark:bg-charcoal overflow-hidden">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="animate-in fade-in slide-in-from-left duration-700 delay-200">
              <div className="flex items-center gap-2 mb-6 md:mb-8">
                ...
                <span className="text-gold font-bold uppercase tracking-widest text-xs">Public Relations</span>
              </div>
              ...
              <p className="text-silver/70 text-base sm:text-xl mb-8 md:mb-12 leading-relaxed max-w-xl">
                For detailed inquiries regarding our public notices, media 
                publications, or statutory disclosures, please connect with 
                our Corporate Communications desk.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                ...
                <div className="flex items-center gap-5 px-6 sm:px-8 py-5 sm:py-6 bg-white/5 border border-white/10 rounded-xl text-white">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-[0.2em]">Global Transparency</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between w-full animate-in fade-in slide-in-from-right duration-700 delay-400">
              ...
              >
                <div className="p-6 sm:p-10 bg-white/5 border border-white/10 rounded-2xl hover:border-gold/50 transition-all group/card w-full min-w-full sm:min-w-0 sm:w-full shrink-0 snap-center shadow-sm">
                  ...
                  <h4 className="text-white font-bold text-xs sm:text-sm uppercase tracking-widest mb-2">Media Queries</h4>
                ...
                <div className="p-6 sm:p-10 bg-white/5 border border-white/10 rounded-2xl hover:border-gold/50 transition-all group/card w-full min-w-full sm:min-w-0 sm:w-full shrink-0 snap-center shadow-sm">
                  ...
                  <h4 className="text-white font-bold text-xs sm:text-sm uppercase tracking-widest mb-2">Direct Helpline</h4>
                ...
                <div className="sm:col-span-2 p-6 sm:p-10 bg-white/2 border border-white/5 rounded-2xl flex items-center justify-between w-full min-w-full sm:min-w-0 sm:w-full shrink-0 snap-center shadow-sm">
                  <div className="flex items-center gap-4 sm:gap-6">
                    ...
                    <div>
                      <h4 className="text-white font-bold text-xs uppercase tracking-widest mb-1">Investor Outreach</h4>
                      <p className="text-silver/60 text-xs leading-relaxed">Access our primary nodal officer for media-related statutory clarifications.</p>
                    </div>
                  </div>
                  <div className="hidden sm:flex items-center gap-3">
                    <Info className="w-6 h-6 text-gold/20" />
                  </div>
                </div>
              </div>
