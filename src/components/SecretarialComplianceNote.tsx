        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-10 bg-white dark:bg-charcoal border border-border rounded-sm hover:shadow-2xl transition-all group">
              ...
              <div className="p-10 bg-white dark:bg-charcoal border border-border rounded-sm hover:shadow-2xl transition-all group translate-y-8">
