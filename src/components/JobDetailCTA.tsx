            ...
            <div className="animate-in fade-in slide-in-from-left duration-700 delay-200">
              ...
              <div className="flex flex-col sm:row gap-6">
                <button 
                  ...
                  className="px-12 py-6 bg-gold text-charcoal font-bold text-[10px] uppercase tracking-[0.3em] rounded-sm transition-all flex items-center justify-center gap-4 shadow-2xl hover:bg-white"
                >
                  Apply For This Role
