        ...
        >
          {releases.map((release) => (
            <motion.div 
              ...
              key={release.id}
              className="group relative flex flex-col bg-silver/5 dark:bg-charcoal border border-border/50 dark:border-white/5 rounded-sm p-10 hover:border-gold/30 dark:hover:border-gold/30 transition-colors duration-700 shadow-lg hover:shadow-2xl overflow-hidden"
            >
              {/* Subtle hover glow */}
