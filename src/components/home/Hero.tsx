        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[4.25rem] xl:text-[4.75rem] font-heading font-black tracking-tight leading-[1.08] text-white">
              <span className="block text-slate-300/80 font-extrabold">
                Precision in every bend.
              </span>
              <span className="block text-white font-black mt-1 sm:mt-2">
          ...
          <div className="lg:col-span-5 lg:pl-4 flex flex-col justify-center">
            <p className="text-base sm:text-lg text-slate-200/90 font-normal leading-relaxed mb-8 max-w-lg">
            ...
            <div className="flex flex-wrap items-center gap-3.5 sm:gap-4">
              <Link
                href="/products"
                className="px-7 py-3.5 rounded-full bg-white hover:bg-slate-100 dark:bg-[#7BA4D0] dark:hover:bg-white text-[#0D2440] dark:text-[#0D2440] font-heading font-bold text-xs uppercase tracking-wider transition-all duration-300 hover:scale-105 active:scale-95 inline-flex items-center justify-center gap-2 group"
              >
