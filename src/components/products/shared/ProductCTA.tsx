...
export function ProductCTA() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative py-12 md:py-20 bg-white dark:bg-[#071321] text-[#0D2440] dark:text-white transition-colors duration-300 border-t border-[#7BA4D0]/20 dark:border-white/10 overflow-visible"
    >
      <div className="container-custom relative z-10 w-full">
        {/* Short, Crisp & Summarised Elevated Card (Expanded Horizontal Width) */}
        <motion.div
