  ...
  return (
    <section className="py-16 md:py-24 bg-white dark:bg-black relative overflow-visible">
      <div className="container-custom relative z-10">
        <div className="relative rounded-3xl sm:rounded-[36px] bg-gradient-to-br from-[#EBF3FC] via-[#F2F7FD] to-[#E2EFFC] border border-[#7BA4D0]/35 p-8 md:p-14 lg:p-16 shadow-[0_20px_60px_-15px_rgba(46,94,153,0.08)] overflow-hidden">
