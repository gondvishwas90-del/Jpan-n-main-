      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/80 dark:bg-charcoal/80 border border-[#7BA4D0]/30 text-[#2E5E99] text-xs font-bold uppercase tracking-widest mb-6">
            ...
            <div className="flex flex-col justify-between w-full">
              ...
              >
                <div className="p-6 sm:p-8 bg-white/80 dark:bg-charcoal/80 backdrop-blur-sm border border-[#7BA4D0]/25 rounded-2xl hover:border-[#2E5E99]/40 hover:shadow-md transition-all group/card w-full min-w-full sm:min-w-0 sm:w-full shrink-0 snap-center">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-xs leading-relaxed">
                        Access our primary nodal officer for statutory audio disclosure queries.
                      </p>
                    </div>
                  </div>
                  <div className="hidden sm:flex items-center gap-3">
                    <MessageSquare className="w-5 h-5 text-[#7BA4D0]" />
                  </div>
                </div>
              </div>
