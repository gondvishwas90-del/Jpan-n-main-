            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                ...
                <div className="flex items-center justify-center gap-3 px-6 py-4 bg-white/80 dark:bg-charcoal/80 border border-[#7BA4D0]/30 rounded-xl text-[#0D2440] dark:text-white text-xs font-bold uppercase tracking-wider">
                  <BarChart3 className="w-4 h-4 text-[#2E5E99] shrink-0" />
            ...
            <div className="flex flex-col justify-between w-full">
              ...
              >
                ...
                <div className="p-6 sm:p-8 bg-white/80 dark:bg-charcoal/80 backdrop-blur-sm border border-[#7BA4D0]/25 rounded-2xl hover:border-[#2E5E99]/40 hover:shadow-md transition-all group/card w-full min-w-full sm:min-w-0 sm:w-full shrink-0 snap-center">
                  ...
                  <p className="text-muted-foreground text-xs font-medium">Request for Information</p>
                </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-xs leading-relaxed">
                        Access comprehensive responses to common ownership and dividend queries.
                      </p>
                    </div>
                  </div>
                  <div className="hidden sm:flex items-center gap-3">
                    <FileSearch className="w-5 h-5 text-[#7BA4D0]" />
                  </div>
                </div>
              </div>
