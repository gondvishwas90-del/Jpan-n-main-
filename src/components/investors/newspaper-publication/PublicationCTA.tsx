            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                ...
                <div className="flex items-center justify-center gap-3 px-6 py-4 bg-white/80 dark:bg-charcoal/80 border border-[#7BA4D0]/30 rounded-xl text-[#0D2440] dark:text-white text-xs font-bold uppercase tracking-wider">
                  <Globe className="w-4 h-4 text-[#2E5E99] shrink-0" />
                  <span>Global Transparency</span>
                </div>
              </div>
            </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-xs leading-relaxed">
                        Access our primary nodal officer for media-related statutory clarifications.
                      </p>
                    </div>
                  </div>
                  <div className="hidden sm:flex items-center gap-3">
                    <Info className="w-5 h-5 text-[#7BA4D0]" />
                  </div>
                </div>
              </div>
