  ...
  return (
    <section className="py-16 md:py-24 bg-white dark:bg-black overflow-hidden transition-colors">
      <div className="container-custom">
        <div className="bg-gradient-to-br from-[#EBF3FC] via-[#F2F7FD] to-[#E2EFFC] dark:bg-charcoal/50 border border-[#7BA4D0]/35 p-8 sm:p-12 md:p-16 rounded-3xl sm:rounded-[36px] relative group overflow-hidden max-w-6xl mx-auto shadow-xs">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="px-8 py-4 bg-[#0D2440] hover:bg-[#2E5E99] text-white font-bold text-xs uppercase tracking-wider rounded-xl transition-all flex items-center justify-center gap-3 shadow-md hover:shadow-lg group whitespace-nowrap">
            ...
            <div className="flex flex-col justify-between w-full">
              ...
              >
                <div className="p-6 sm:p-7 bg-white dark:bg-charcoal border border-[#7BA4D0]/25 rounded-2xl sm:rounded-3xl hover:border-[#2E5E99]/50 hover:shadow-md transition-all group/card w-full min-w-full sm:min-w-0 sm:w-full shrink-0 snap-center shadow-xs">
                ...
                <div className="sm:col-span-2 p-6 sm:p-7 bg-white dark:bg-charcoal rounded-2xl sm:rounded-3xl flex items-center justify-between group/live border border-[#7BA4D0]/25 w-full min-w-full sm:min-w-0 sm:w-full shrink-0 snap-center shadow-xs">
