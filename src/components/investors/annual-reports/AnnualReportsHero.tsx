    ...
    <section className="relative h-[80vh] min-h-[540px] max-h-[820px] pt-32 sm:pt-36 pb-12 sm:pb-16 flex items-center overflow-hidden bg-[#071321]">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt="Annual Reports - J Pan Precision"
          fill
          priority
          sizes="100vw"
      ...
      <div className="container-custom relative z-10 text-white w-full">
        <div className="max-w-3xl space-y-6">
          {/* Category Tag with visual accent */}
          <motion.div 
          ...
          >
            Annual Reports & <br />
            <span className="text-[#7BA4D0]">Financial Filings.</span>
          </motion.h1>
          ...
          >
            Comprehensive financial statements, independent audit reports, operational milestones, and strategic governance disclosures for valued stakeholders.
          </motion.p>
        </div>
      </div>
    </section>
