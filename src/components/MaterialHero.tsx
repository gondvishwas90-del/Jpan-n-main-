...
import { ShieldCheck, CheckCircle2, FileText, Scale, FileCheck, ExternalLink } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            >
              ...
              <span className="text-gold">/</span>
              <span className="text-gold font-extrabold">Material Documents</span>
            </motion.nav>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span>SEBI Regulation 30 Compliant</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-gold" />
                <span>100% Board Certified Directives</span>
              </div>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-4 hidden lg:block">
            ...
            >
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-heading font-bold text-white">Contract Archive</h3>
                <p className="text-xs text-white/70 leading-relaxed font-normal">
                  Instant access to Memorandum of Association (MOA), Articles of Association (AOA), material JV agreements, and key joint venture filings.
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-white/10 flex items-center justify-between text-xs font-bold text-gold">
                <div className="flex items-center gap-2">
                  ...
                  <span>Public Inspection Ready</span>
                </div>
                <ExternalLink className="w-4 h-4 text-white/50 group-hover:text-gold transition-colors" />
              </div>
            </motion.div>
          </div>
