...
import { Factory, Box, ShieldCheck, CheckCircle2 } from "lucide-react";
...
export function ProductsHero() {
  ...
  return (
    <section 
      ref={containerRef}
      className="relative min-h-[460px] md:min-h-[500px] pt-32 pb-20 flex items-center overflow-hidden bg-[#070d14]"
    >
      ...
      >
        <Image
          ...
          alt="J Pan Tubular Components Limited Precision Components"
          fill
          priority
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-gold font-extrabold">Products Catalog</span>
            </motion.nav>
            ...
            {/* Main H1 Title - Exact Text Kept Unchanged, Fixed Typography Size */}
            <motion.h1 
            ...
            >
              Our <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-silver via-gold to-white italic font-medium">
                Manufacturing
              </span>{" "}
              Solutions
            </motion.h1>

            {/* Subtitle Paragraph - Exact Text Kept Unchanged */}
            <motion.p 
            ...
            >
              Explore our complete range of high-precision copper and steel components, engineered for maximum reliability in critical thermal and mechanical systems.
            </motion.p>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span>Industry Standard A+ Certified</span>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div className="lg:col-span-4 hidden lg:block">
            ...
            >
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-heading font-bold text-white">Precision Machined</h3>
                <p className="text-xs text-white/70 leading-relaxed font-normal">
                  High-capacity CNC rotary bending, end forming, and branch assemblies for HVAC, Automotive, and Power Generation.
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-white/10 flex items-center justify-between text-xs font-bold text-gold">
                <div className="flex items-center gap-2">
                  ...
                  <span>5 Active Manufacturing Plants</span>
                </div>
              </div>
            </motion.div>
          </div>
