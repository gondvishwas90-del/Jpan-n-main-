          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-gold font-bold uppercase tracking-widest text-xs">Strategic Engagement</span>
              </div>
              <h2 className="text-3xl md:text-5xl font-heading font-bold text-white mb-8 leading-tight">
                Explore our <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-silver to-gold">Growth Narrative</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="p-8 bg-white/5 border border-white/10 rounded-sm hover:border-gold/50 transition-all group/card">
                ...
                <h4 className="text-white font-bold text-xs uppercase tracking-widest mb-2">Strategic Desk</h4>
                <p className="text-silver/40 text-[10px]">+91 (22) 9876-5432</p>
              </div>
              <div className="sm:col-span-2 p-8 bg-white/2 border border-white/5 rounded-sm flex items-center justify-between">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <h4 className="text-white font-bold text-xs uppercase tracking-widest mb-1">Global Strategic Network</h4>
                    <p className="text-silver/30 text-[10px]">Coordinating strategic insights across our international manufacturing hubs.</p>
                  </div>
                </div>
