...
import { ShieldCheck, BarChart3, Scale, TrendingUp } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          <div className="animate-in fade-in slide-in-from-left duration-700">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-gold font-bold uppercase tracking-widest text-xs">Financial Authority</span>
            </div>
            <h2 className="text-3xl md:text-5xl font-heading font-bold text-charcoal dark:text-white mb-8 leading-tight">
              Institutional <br />
              <span className="text-deepblue dark:text-gold italic font-medium">Credit Validation</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
               <div className="flex items-start gap-4 group cursor-pointer">
                  ...
                  <div>
                    <h4 className="text-[10px] font-bold text-charcoal dark:text-white uppercase tracking-widest mb-2">Objective Analysis</h4>
                    <p className="text-[11px] text-muted-foreground leading-relaxed">Independent assessment based on rigorous financial methodology.</p>
                  </div>
               </div>
               <div className="flex items-start gap-4 group cursor-pointer">
                  <div className="w-12 h-12 bg-silver/5 flex items-center justify-center rounded-sm shrink-0 border border-border transition-all duration-500 group-hover:-translate-y-1 group-hover:bg-gold group-hover:border-gold group-hover:shadow-[0_8px_16px_-6px_rgba(212,175,55,0.4)]">
                  ...
                  <div>
                    <h4 className="text-[10px] font-bold text-charcoal dark:text-white uppercase tracking-widest mb-2">Stakeholder Trust</h4>
                    <p className="text-[11px] text-muted-foreground leading-relaxed">Providing a verified measure of fiscal strength and reliability.</p>
                  </div>
               </div>
            </div>
          </div>
          ...
          <div className="relative animate-in fade-in slide-in-from-right duration-700 delay-200">
            <div className="p-12 bg-charcoal dark:bg-black/20 border border-white/5 rounded-sm relative overflow-hidden group shadow-2xl">
               ...
               <div className="relative z-10">
                  <BarChart3 className="w-16 h-16 text-gold/20 mb-8" />
                  ...
                  <div className="space-y-10">
                    <div className="flex gap-6">
                       ...
                       <p className="text-xs text-silver/40 leading-relaxed italic">
                         "A strong credit rating is a testament to our disciplined 
                         capital management and strategic growth performance."
                       </p>
                    </div>
                    <div className="flex gap-6">
                       <span className="text-gold font-bold text-xl">/02</span>
                       <p className="text-xs text-silver/40 leading-relaxed italic">
                         "We maintain an open dialogue with rating agencies to ensure 
                         accurate and timely reflection of our financial position."
                       </p>
                    </div>
                  </div>
               </div>
