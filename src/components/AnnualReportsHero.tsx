...
import { ShieldCheck, CheckCircle2, FileText, Download, TrendingUp } from "lucide-react";

export function AnnualReportsHero() {
  return (
    <section className="relative min-h-[460px] md:min-h-[520px] pt-32 pb-20 flex items-center overflow-hidden bg-[#070d14]">
      {/* Immersive Background Layer */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/annual_reports_hero.png" 
          alt="Annual Reports - Investor Journey"
          fill
          priority
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            >
              ...
              <span className="text-gold">/</span>
              <span className="text-gold font-extrabold">Annual Reports</span>
            </motion.nav>
            ...
            >
              ...
              <span className="text-gold font-extrabold uppercase tracking-[0.3em] text-xs">
                OFFICIAL FINANCIAL AUDITS & DISCLOSURES
              </span>
            </motion.div>
            ...
            <motion.p 
              ...
              className="text-lg sm:text-xl text-white/80 font-normal leading-relaxed max-w-2xl border-l-2 border-gold/50 pl-5"
            >
              Navigating Success: Comprehensive financial statements, independent audit reports, operational milestones, and strategic governance disclosures for valued stakeholders.
            </motion.p>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <span>MCA & Regulatory Compliant</span>
              </div>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-4 hidden lg:block">
            ...
            >
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-heading font-bold text-white">Annual Disclosures Desk</h3>
                <p className="text-xs text-white/70 leading-relaxed font-normal">
                  Access verified annual balance sheets, P&L statements, director reports, and auditor opinions spanning all operational fiscal years.
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-white/10 flex items-center justify-between text-xs font-bold text-gold">
                <div className="flex items-center gap-2">
                  ...
                  <span>26+ Years Fiscal Growth</span>
                </div>
                <Download className="w-4 h-4 text-white/50 group-hover:text-gold transition-colors" />
              </div>
            </motion.div>
          </div>
