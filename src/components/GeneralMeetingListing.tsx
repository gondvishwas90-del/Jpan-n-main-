        ...
        <div className="container-custom">
          ...
          <div className="space-y-4">
            {notices.map((notice) => (
              <div 
                key={notice.id}
                className="group bg-white dark:bg-charcoal border border-border p-6 md:p-10 rounded-sm hover:border-gold hover:shadow-2xl transition-all duration-500 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-12"
              >
