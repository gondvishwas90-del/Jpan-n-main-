...
import { ShieldCheck, BookOpen, ScrollText, CheckCircle2, FileCheck } from "lucide-react";
...
export function PoliciesHero() {
  return (
    <section className="relative min-h-[460px] md:min-h-[500px] pt-32 pb-20 flex items-center overflow-hidden bg-[#070d14]">
      {/* Background Media with Dark Industrial Overlay */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/corporate-office.png" 
          alt="J Pan Tubular Components Limited Policies and Governance"
          fill
          priority
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            >
              ...
              <span className="text-gold">/</span>
              <span className="text-gold font-extrabold">Corporate Policies</span>
            </motion.nav>
            ...
            >
              Defining our standards of integrity, ethics, and operational excellence. Explore our comprehensive repository of statutory rules and internal corporate guidelines.
            </motion.p>
          ...
          <div className="lg:col-span-4 hidden lg:block">
            ...
            >
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-heading font-bold text-white">Institutional Governance</h3>
                <p className="text-xs text-white/70 leading-relaxed font-normal">
                  Our corporate policies govern risk management, insider trading, whistle-blowing, ESG commitments, and board member oversight.
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-white/10 flex items-center justify-between text-xs font-bold text-gold">
                ...
                <BookOpen className="w-4 h-4 text-white/50 group-hover:text-gold transition-colors" />
              </div>
            </motion.div>
          </div>
