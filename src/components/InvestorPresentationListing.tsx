        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {presentations.map((pres) => (
              <div 
                key={pres.id}
                className="group bg-white dark:bg-charcoal border border-border rounded-sm overflow-hidden hover:border-gold transition-all duration-500 hover:shadow-2xl flex flex-col"
              >
